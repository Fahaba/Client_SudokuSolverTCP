...
//            System.err.println(boxName);
            ...
            Process p = new ProcessBuilder("E:\\UniProjekte\\Client_SudokuTCP\\Debug\\SudokuTCP.exe", boxName, initString, "127.0.0.1", "1337").start();
            //System.out.println(p.getInputStream().toString());

            template.request("http://127.0.0.1:4242/api/ready?box=sudoku%2F"+boxName.toLowerCase(), null);
